...
> **Last Updated**: 2025-12-07 17:12:08
...
- **Conforming (PASS)**: 230 (64.8%)
- **Non-conforming (FAIL)**: 125 (35.2%)

### Result Distribution

- **OK Results**: 93 (26.2%)
- **Syntax Errors**: 259 (73.0%)
- **Type Errors**: 2 (0.6%)
- **Other Errors**: 1 (0.3%)
...
| 48 | `writeq(//*).` | OK | OK | PASS | OK | OK |  |
| 49 | `writeq(//*./*/).` | OK | OK | PASS | OK | OK |  |
| 50 | `writeq('/**').` | OK | OK | PASS | OK | OK |  |
| 51 | `writeq('*/').` | OK | OK | PASS | OK | OK |  |
| 52 | `"'\\`\"" = "'`"".` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated strin... |
| 53 | `"'\\"" = "'"".` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
| 54 | `\\` = `'.` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
| 55 | `'\\`\"' = ''`'.` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
| 56 | `writeq(''\\`\"\"').` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated strin... |
| 57 | `('\\\\') = (\\).` | OK | OK | PASS | OK | OK |  |
...
| 67 | `/**/ 1.0e- 9 = -(e(1.0),9).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(No terminal matche... |
| 68 | `/**/ writeq(1e).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(No terminal matche... |
| 69 | `/**/ writeq(1.0e).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(No terminal matche... |
...
| 82 | `atom(-/**/-).` | SYNTAX_ERROR | OK | FAIL | OK | OK |  |
| 83 | `op(0,fy,-).` | OK | OK | PASS | OK | OK |  |
| 84 | `/**/ integer(-1).` | OK | OK | PASS | OK | OK |  |
| 85 | `/**/ integer(- 1).` | OK | OK | PASS | OK | OK |  |
| 86 | `/**/ writeq(-(1)).` | OK | OK | PASS | OK | OK |  |
| 87 | `/**/ writeq([-]).` | OK | OK | PASS | OK | OK |  |
...
| 104 | `/**/ writeq(- (1~2)).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(No terminal matche... |
| 105 | `/**/ writeq(1~2).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(No terminal matche... |
...
| 108 | `/**/ writeq('$VAR'(0)).` | OK | OK | PASS | OK | OK |  |
| 109 | `/**/ writeq('$VAR'(-1)).` | OK | OK | PASS | OK | OK |  |
...
| 120 | `/**/ X=[a&#124;b].` | OK | OK | PASS | SYNTAX_ERROR | OK |  |
| 121 | `/**/ X=[(a&#124;b)].` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(No terminal matche... |
| 122 | `/**/ [a&#124;[]=[a].` | OK | SYNTAX_ERROR | FAIL | WAITS | OK | error(syntax_error(No terminal matche... |
| 123 | `/**/ X=[a&#124;b&#124;c].` | OK | SYNTAX_ERROR | FAIL | SYNTAX_ERROR | OK | error(syntax_error(No terminal matche... |
...
| 150 | `a = '\141\'.` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
...
| 156 | `X = '\77777777777\'.` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
| 157 | `a = '\x61\'.` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
| 158 | `atom_codes('\xG\',Cs).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
| 159 | `atom_codes('\xG1\',Cs).` | OK | SYNTAX_ERROR | FAIL | SYNTAX_ERROR | OK | error(syntax_error(Unterminated quote... |
...
| 166 | `0''' = 0'\'.` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
| 167 | `integer(0'').` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Unterminated quote... |
| 168 | `op(100,xf,'').` | OK | OK | PASS | OK | OK |  |
| 169 | `/**/ (0 '') = ''(X).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 170 | `/**/ writeq(0 '').` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 171 | `/**/ writeq(0'').` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 172 | `op(100,xfx,'').` | SYNTAX_ERROR | SYNTAX_ERROR | PASS | OK | OK | error(syntax_error(Empty terminals ar... |
| 173 | `/**/ functor(0 ''1, F, A).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 174 | `/**/ functor(0''1, F, A).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 175 | `op(100,xf,f). writeq(0'f\').` | SYNTAX_ERROR | SYNTAX_ERROR | PASS | OK | OK | error(syntax_error(Empty terminals ar... |
| 176 | `/**/ writeq(0'f'f').` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 177 | `/**/ writeq(0'ff).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 178 | `/**/ writeq(0f).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
...
| 182 | `/**/ functor(2 '1'y, F, A).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
...
| 198 | `/**/ writeq(' op' '1').` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 199 | `/**/ writeq(' op'[]).` | OK | SYNTAX_ERROR | FAIL | FAIL | OK | error(syntax_error(Empty terminals ar... |
...
| 205 | `/**/ writeq([1]).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 206 | `/**/ writeq(-[1]).` | OK | SYNTAX_ERROR | FAIL | WAITS | OK | error(syntax_error(Empty terminals ar... |
| 207 | `/**/ X = 1.e.` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
...
| 216 | `/**/ write_canonical(fy yf).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 217 | `/**/ writeq(fy(yf(1))).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 218 | `/**/ writeq(yf(fy(1))).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 219 | `/**/ writeq(yf(fy(yf(fy(1))))).` | OK | SYNTAX_ERROR | FAIL | FAIL | OK | error(syntax_error(Empty terminals ar... |
...
| 221 | `/**/ writeq(fy(yfx(1,2))).` | OK | SYNTAX_ERROR | FAIL | SYNTAX_ERROR | OK | error(syntax_error(Empty terminals ar... |
| 222 | `/**/ writeq(yfx(fy(1),2)).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
...
| 224 | `/**/ writeq(xfy(1,yf(2))).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 225 | `/**/ writeq(yf(xfy(1,2))).` | OK | SYNTAX_ERROR | FAIL | ERROR | OK | error(syntax_error(Empty terminals ar... |
...
| 229 | `/**/ writeq(p(p(0))).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 230 | `/**/ write_canonical(p 0 p).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 231 | `/**/ write_canonical(0 p p).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 232 | `/**/ write_canonical(p p).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
...
| 238 | `/**/ writeq((a&#124;b)).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 239 | `op(0,xfy,.),op(9,yf,.).` | SYNTAX_ERROR | SYNTAX_ERROR | PASS | SYNTAX_ERROR | OK | error(syntax_error(Empty terminals ar... |
| 240 | `/**/ writeq(.(.)).` | OK | SYNTAX_ERROR | FAIL | SYNTAX_ERROR | OK | error(syntax_error(Empty terminals ar... |
...
| 243 | `/**/ writeq("a").` | OK | SYNTAX_ERROR | FAIL | SYNTAX_ERROR | OK | error(syntax_error(Empty terminals ar... |
| 244 | `/**/ writeq("\z").` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 245 | `/**/ writeq("\0\").` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
...
| 252 | `/**/ writeq((a-->b,c&#124;d)).` | OK | SYNTAX_ERROR | FAIL | SYNTAX_ERROR | OK | error(syntax_error(Empty terminals ar... |
| 253 | `/**/ write_canonical((a&#124;b;c)).` | OK | SYNTAX_ERROR | FAIL | SYNTAX_ERROR | OK | error(syntax_error(Empty terminals ar... |
| 254 | `/**/ write_canonical((a;b&#124;c)).` | OK | SYNTAX_ERROR | FAIL | SYNTAX_ERROR | OK | error(syntax_error(Empty terminals ar... |
| 255 | `/**/ write_canonical([a;b&#124;c]).` | OK | SYNTAX_ERROR | FAIL | SYNTAX_ERROR | OK | error(syntax_error(Empty terminals ar... |
| 256 | `/**/ writeq([(a&#124;b)]).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
...
| 273 | `/**/ writeq(1 = f).` | OK | SYNTAX_ERROR | FAIL | N/A | N/A | error(syntax_error(Empty terminals ar... |
...
| 276 | `/**/ writeq(>(>.(a),b)).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 277 | `/**/ write_canonical(a>. >b).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 278 | `/**/ write_canonical(a>. =b).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 279 | `/**/ write_canonical((a>.,b)).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 280 | `/**/ write_canonical(a>.).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 281 | `op(699,xf,>).` | SYNTAX_ERROR | SYNTAX_ERROR | PASS | OK | OK | error(syntax_error(Empty terminals ar... |
| 282 | `/**/ writeq(>(>(a),b)).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 283 | `/**/ write_canonical(a> >b).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 284 | `/**/ write_canonical(a> =b).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 285 | `/**/ write_canonical((a>,b)).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 286 | `/**/ write_canonical(a>).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 287 | `/**/ write_canonical(a>b).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 288 | `op(9,yfx,[bop,bo,b,op,xor]). writeq(0bop 2).` | SYNTAX_ERROR | SYNTAX_ERROR | PASS | FAIL | OK | error(syntax_error(Empty terminals ar... |
| 289 | `/**/ writeq(0 bop 2).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 290 | `/**/ writeq(0bo 2).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 291 | `/**/ writeq(0b 2).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 292 | `/**/ writeq(0op 2).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 293 | `/**/ writeq(0xor 2).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
...
| 296 | `/**/ writeq(0b2).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
| 297 | `/**/ writeq(0o8).` | OK | SYNTAX_ERROR | FAIL | ERROR | OK | error(syntax_error(Empty terminals ar... |
...
| 304 | `/**/ op(0,fy,--),writeq(--(a)).` | OK | SYNTAX_ERROR | FAIL | OK | OK | error(syntax_error(Empty terminals ar... |
